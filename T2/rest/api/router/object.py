...
from api.utils.minio import delete_file, create_local_temp_file, delete_local_temp_file, upload_file
...
def create():
    ...
    try:
        ...
        file_path = create_local_temp_file(base64_string=req["file"]["base64"], filename=req["file"]["name"], owner_id=req["owner"]) 
...
def update(object_id):
    ...
    try:
        if("base64" in req["file"]):
            ...
            delete_file("svp", f"{req['owner']}/{old_file['name']}")
